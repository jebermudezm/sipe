...
public class TabActivityClientes extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_activity_clientes);
        ConsultarClientes("");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tab_activity_clientes, menu);
        return true;
    }
    ...
    private void ConsultarClientes(String p) {
        DataBaseManager manager = new DataBaseManager(getApplicationContext());
        Cursor cur = manager.ObtenerClientes(p);
        ...
        while (cur.moveToNext()){
            ...
            objitem.setItem1(cur.getString(6));
            objitem.setitem2(cur.getString(0)+"-"+cur.getString(1)+"-"+cur.getString(10));
            arrayItems[i] = objitem;
            i++;
        }
        ListView li = (ListView) findViewById(R.id.lvClientesPreventa);
        //Adaptador
